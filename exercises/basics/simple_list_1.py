...
# TODO: print the second element of the list


# TODO: print the length of the list


# TODO: write an if statement that checks if the list is longer than five
#  if it is, print a message that the list is longer
# if len(

# TODO: add an else that informs that the list is shorter than five
